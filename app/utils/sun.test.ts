...
it('tests getTrueAnomaly', () => {
    ...
    expect(getTrueAnomaly(T)).toBeCloseTo(277.096642);
});

it('tests getTrueLongitude', () => {
    const T = -0.072183436;

    expect(getTrueLongitude(T)).toBeCloseTo(199.90987);
});

it('tests getApparentLongitude', () => {
    const T = -0.072183436;

    expect(getApparentLongitude(T)).toBeCloseTo(199.908939);
});

it('tests getEquationOfCenter', () => {
    const T = -0.072183436002738;

    expect(getEquationOfCenter(T)).toBeCloseTo(-1.897324);
});
