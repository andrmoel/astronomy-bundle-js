...
it('tests getHeliocentricEclipticRectangularJ2000Coordinates', () => {
    ...
    expect(y).toBeCloseTo(-0.0225186048, 8);
...
it('tests getHeliocentricEclipticRectangularDateCoordinates', () => {
    ...
    expect(y).toBeCloseTo(-0.0225183665, 8);
...
it('tests getHeliocentricEclipticSphericalJ2000Coordinates', () => {
    ...
    expect(lon).toBeCloseTo(181.794837329, 8);
    expect(lat).toBeCloseTo(3.2962102467, 8);
...
it('tests getHeliocentricEclipticSphericalDateCoordinates', () => {
    ...
    expect(lon).toBeCloseTo(181.7948183222, 8);
    expect(lat).toBeCloseTo(3.2962102682, 8);
...
it('tests getGeocentricEclipticRectangularJ2000Coordinates', () => {
    ...
    expect(x).toBeCloseTo(-0.5500795008, 8);
    expect(y).toBeCloseTo(-0.9912997074, 8);
...
it('tests getGeocentricEclipticRectangularDateCoordinates', () => {
    ...
    expect(x).toBeCloseTo(-0.550079832, 8);
    expect(y).toBeCloseTo(-0.9912995253, 8);
...
it('tests getGeocentricEclipticSphericalJ2000Coordinates', () => {
    ...
    expect(lon).toBeCloseTo(240.9737835744, 8);
    expect(lat).toBeCloseTo(2.0919419728, 8);
...
it('tests getGeocentricEclipticSphericalDateCoordinates', () => {
    ...
    expect(lon).toBeCloseTo(240.973764471, 8);
    expect(lat).toBeCloseTo(2.0919421363, 8);
...
it('tests getGeocentricEquatorialSphericalJ2000Coordinates', () => {
    ...
    expect(rightAscension).toBeCloseTo(239.2875759378, 8);
    expect(declination).toBeCloseTo(-18.3046708182, 8);
    expect(radiusVector).toBeCloseTo(1.1344502836, 8);
});
...
it('tests getGeocentricEquatorialSphericalDateCoordinates', () => {
    ...
    expect(rightAscension).toBeCloseTo(239.2875562845, 8);
    expect(declination).toBeCloseTo(-18.3046667774, 8);
    expect(radiusVector).toBeCloseTo(1.1344502852, 8);
});
...
it('tests getDistanceToEarth', () => {
    ...
    expect(d).toBeCloseTo(169711346.7167513, 6);
});
