...
it('tests getGeocentricEclipticRectangularDateCoordinates', () => {
    ...
    expect(coords.z).toBeCloseTo(-0.00000243, 8);
});
...
it('tests getGeocentricEclipticSphericalDateCoordinates', () => {
    ...
    expect(coords.lat).toBeCloseTo(-0.00014017, 8);
    expect(coords.radiusVector).toBeCloseTo(0.99514386, 8);
});
...
it('tests getGeocentricEquatorialSphericalDateCoordinates', () => {
    ...
    expect(coords.rightAscension).toBeCloseTo(207.25762788, 8);
    expect(coords.declination).toBeCloseTo(-11.22974218, 8);
    expect(coords.radiusVector).toBeCloseTo(0.99514386, 8);
});
...
it('tests getApparentGeocentricEclipticRectangularCoordinates', () => {
    ...
    expect(z).toBeCloseTo(-0.00000243, 8);
});
...
it('tests getApparentGeocentricEquatorialSphericalCoordinates', () => {
    ...
    expect(coords.rightAscension).toBeCloseTo(207.2473691, 8);
    expect(coords.declination).toBeCloseTo(-11.22593849, 8);
    expect(coords.radiusVector).toBeCloseTo(0.99514386, 8);
});
...
it('tests getTopocentricDistanceToEarth', () => {
    ...
    expect(d).toBeCloseTo(148871013.470828, 6);
});
//
// it('tests getTransit',  () => {
