...
describe('getTauOfGreatestEclipse', () => {
    it('returns the tau of greatest eclipse for a partial eclipse', () => {
        expect(getTauOfGreatestEclipse(elementsPartial)).toBeCloseTo(-0.28986, 5);
    });

    it('returns the tau of greatest eclipse for a total eclipse', () => {
        expect(getTauOfGreatestEclipse(elementsTotal)).toBeCloseTo(-0.21507, 5);
    });
});
